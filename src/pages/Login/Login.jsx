...
const Login = () => {
    ...
    return (
        <div className='bg-amber-900 h-screen lg:flex relative'>
                    ...
                    <div className='min-w-[320px]'>
                        <form action="" className=''>
                            ...
                            <div className='relative'>
                                <input name='password' type={showPassword ? 'text' : 'password'} className="input text-black" placeholder="Password" required /><br />
                                <button
                        ...
                        <p className='mt-3'>
                            Don't have account? <Link to="/register" className='text-blue-500'>Sign up</Link>
                        </p>
